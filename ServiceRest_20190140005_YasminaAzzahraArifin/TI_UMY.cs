...
namespace ServiceRest_20190140005_YasminaAzzahraArifin
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source = ACHI; Initial Catalog = \"TI UMY\"; Persist Security Info = True; User ID = sa; Password = 240701");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source = ACHI; Initial Catalog = \"TI UMY\"; Persist Security Info = True; User ID = sa; Password = 240701");
